...
func (cv AuthValidator) generateValidationMessage(field string, rule string) (message string) {
	switch rule {
	case "required":
...
func (cv AuthValidator) GenerateValidationResponse(err error) []response.ValidationError {
